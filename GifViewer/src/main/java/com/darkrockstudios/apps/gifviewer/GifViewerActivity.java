...
public class GifViewerActivity extends Activity {
	...
	protected void onCreate( Bundle savedInstanceState )
	{
		...
		// this activity.
		mSystemUiHider = SystemUiHider.getInstance( this, m_gifImageView, HIDER_FLAGS );
		...
		m_gifImageView.setOnClickListener(new View.OnClickListener() {
			@Override
